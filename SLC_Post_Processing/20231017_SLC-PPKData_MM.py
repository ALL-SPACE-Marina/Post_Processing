        ...
        for k in range(len(cal_freq_list)):
            for l in range(len(Ph_deg)):
                ...
                input_plt = plotsPath + '\\' + plot_title[m] + '_Gain_XP_vs_scan_Phi_' + str(Ph_degree) + 'Freq_' + str(
                    meas_freq_list[k]) + 'GHz.png'
                plot = slide.shapes.add_picture(input_plt, Inches(0.5), Inches(1.5),width=Inches(6), height=Inches(5.14))

                input_plt2 = plotsPath + '\\' + plot_title[m] + '_XPD_vs_scan_Phi_' + str(Ph_degree) + 'Freq_' + str(
                    meas_freq_list[k]) + 'GHz.png'
                plot = slide.shapes.add_picture(input_plt2, Inches(7), Inches(1.5), width=Inches(6),
                                                height=Inches(5.14))
...
for m in range(len(lens_enab)):
    ...
    for p in range(len(Th_deg_list)):
        for l in range(len(Ph_deg)):
            ...
            input_plt2 = plotsPath + '\\' + plot_title[m] + '_XPD_vs_Frequency_Th_' + str(
                Th_deg_list[p]) + '_Phi_' + str(Ph_degree) + '.png'
            plot = slide.shapes.add_picture(input_plt2, Inches(7), Inches(1.5), width=Inches(6), height=Inches(5.14))
